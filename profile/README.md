...
유튜브, 인스타그램, 틱톡 등 여러 SNS 앱들을 돌아다니며 더욱 재밌고 새로운 컨텐츠를 찾아다닙니다.<br><br>
`뉴스피드`는 **다양한 SNS**을 통해 보다 **빠르고 인기 좋은 새로운 컨텐츠**를 제공합니다.<br><br>
사용자는 키워드를 저장해두어 `뉴스피드`가 재밌는 컨텐츠를 발견할 때마다 사용자에게 제공합니다.

![image](https://github.com/play-hooky/newspeed-server/assets/67765871/f50f8b8d-2a7d-4b2a-9dc8-ab6bed8679f2)
